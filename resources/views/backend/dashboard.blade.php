            ...
            <div class="card-body pb-0 d-flex justify-content-between align-items-start">
                <div>
                    <div class="fs-4 fw-semibold">26K <span class="fs-6 fw-normal">(-12.4%
                            <svg class="icon">
                                <use xlink:href="assets/icons/sprites/free.svg#cil-arrow-bottom">
                                </use>
                            </svg>)</span></div>
                    <div>Users</div>
                </div>
            ...
            <div class="card-body pb-0 d-flex justify-content-between align-items-start">
                <div>
                    <div class="fs-4 fw-semibold">$6.200 <span class="fs-6 fw-normal">(40.9%
                            <svg class="icon">
                                <use xlink:href="assets/icons/sprites/free.svg#cil-arrow-top">
                                </use>
                            </svg>)</span></div>
                    <div>Income</div>
                </div>
        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="btn-toolbar d-none d-md-block" role="toolbar"
                ...
                <button class="btn btn-primary" type="button">
                    <svg class="icon">
                        <use xlink:href="assets/icons/sprites/free.svg#cil-cloud-download">
                        </use>
                    </svg>
                </button>
            </div>
        ...
        <div class="card mb-4" style="--cui-card-cap-bg: #3b5998">
            <div
                ...
                <svg class="icon icon-3xl text-white my-4">
                    <use xlink:href="assets/icons/sprites/brand.svg#cib-facebook-f">
                    </use>
                </svg>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="progress-group">
                            <div class="progress-group-header">
                                <svg class="icon icon-lg me-2">
                                    <use xlink:href="assets/icons/sprites/free.svg#cil-user">
                                    </use>
                                </svg>
                                <div>Male</div>
                        ...
                        <div class="progress-group mb-5">
                            <div class="progress-group-header">
                                <svg class="icon icon-lg me-2">
                                    <use xlink:href="assets/icons/sprites/free.svg#cil-user-female">
                                    </use>
                                </svg>
                                <div>Female</div>
                        ...
                        <div class="progress-group">
                            <div class="progress-group-header">
                                <svg class="icon icon-lg me-2">
                                    <use xlink:href="assets/icons/sprites/brand.svg#cib-google">
                                    </use>
                                </svg>
                        ...
                        <div class="progress-group">
                            <div class="progress-group-header">
                                <svg class="icon icon-lg me-2">
                                    <use xlink:href="assets/icons/sprites/brand.svg#cib-twitter">
                                    </use>
                                </svg>
                                <div>Twitter</div>
                        ...
                        <div class="progress-group">
                            <div class="progress-group-header">
                                <svg class="icon icon-lg me-2">
                                    <use xlink:href="assets/icons/sprites/brand.svg#cib-linkedin">
                                    </use>
                                </svg>
                                <div>LinkedIn</div>
                    ...
                    <table class="table border mb-0">
                        <thead class="table-light fw-semibold">
                            <tr class="align-middle">
                                <th class="text-center">
                                    <svg class="icon">
                                        <use xlink:href="assets/icons/sprites/free.svg#cil-people">
                                        </use>
                                    </svg>
                                </th>
                                <th>User</th>
                        ...
                        <tbody>
                            <tr class="align-middle">
                                ...
                                <td class="text-center">
                                    <svg class="icon icon-xl">
                                        <use xlink:href="assets/icons/sprites/flag.svg#cif-us">
                                        </use>
                                    </svg>
                                </td>
                                <td>
                                ...
                                <td class="text-center">
                                    <svg class="icon icon-xl">
                                        <use
                                            xlink:href="assets/icons/sprites/brand.svg#cib-cc-mastercard">
                                        </use>
                                    </svg>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        <button class="btn btn-transparent p-0" type="button"
                                            ...
                                            <svg class="icon">
                                                <use
                                                    xlink:href="assets/icons/sprites/free.svg#cil-options">
                                                </use>
                                            </svg>
                                        </button>
                            ...
                            <tr class="align-middle">
                                ...
                                <td class="text-center">
                                    <svg class="icon icon-xl">
                                        <use xlink:href="assets/icons/sprites/flag.svg#cif-br">
                                        </use>
                                    </svg>
                                </td>
                                <td>
                                ...
                                <td class="text-center">
                                    <svg class="icon icon-xl">
                                        <use xlink:href="assets/icons/sprites/brand.svg#cib-cc-visa">
                                        </use>
                                    </svg>
                                </td>
                                <td>
                            ...
                            <tr class="align-middle">
                                ...
                                <td class="text-center">
                                    <svg class="icon icon-xl">
                                        <use xlink:href="assets/icons/sprites/flag.svg#cif-in">
                                        </use>
                                    </svg>
                                </td>
                                <td>
                                ...
                                <td class="text-center">
                                    <svg class="icon icon-xl">
                                        <use xlink:href="assets/icons/sprites/brand.svg#cib-cc-stripe">
                                        </use>
                                    </svg>
                                </td>
                                <td>
                            ...
                            <tr class="align-middle">
                                ...
                                <td class="text-center">
                                    <svg class="icon icon-xl">
                                        <use xlink:href="assets/icons/sprites/flag.svg#cif-fr">
                                        </use>
                                    </svg>
                                </td>
                                <td>
                                ...
                                <td class="text-center">
                                    <svg class="icon icon-xl">
                                        <use
                                            xlink:href="assets/icons/sprites/brand.svg#cib-cc-paypal">
                                        </use>
                                    </svg>
                                </td>
                                <td>
                            ...
                            <tr class="align-middle">
                                ...
                                <td class="text-center">
                                    <svg class="icon icon-xl">
                                        <use xlink:href="assets/icons/sprites/flag.svg#cif-es">
                                        </use>
                                    </svg>
                                </td>
                                <td>
                                ...
                                <td class="text-center">
                                    <svg class="icon icon-xl">
                                        <use
                                            xlink:href="assets/icons/sprites/brand.svg#cib-cc-apple-pay">
                                        </use>
                                    </svg>
                                </td>
                                <td>
                            ...
                            <tr class="align-middle">
                                ...
                                <td class="text-center">
                                    <svg class="icon icon-xl">
                                        <use xlink:href="assets/icons/sprites/flag.svg#cif-pl">
                                        </use>
                                    </svg>
                                </td>
                                <td>
                                ...
                                <td class="text-center">
                                    <svg class="icon icon-xl">
                                        <use xlink:href="assets/icons/sprites/brand.svg#cib-cc-amex">
                                        </use>
                                    </svg>
                                </td>
                                <td>
